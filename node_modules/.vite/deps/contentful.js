...
var getCleanClone2 = function(object, realm) {
  ...
  if (Constructor === realm.Object) {
    return prototype3 === realm.Object.prototype ? {} : create2(prototype3);
  }
...
var getPrototypeOf3 = Object.getPrototypeOf;
...
function copy(value, options) {
  ...
  var handleCopy = function(value2, cache) {
    ...
    var prototype3 = value2.__proto__ || getPrototypeOf3(value2);
...
var resolveResponse = (response, options) => {
  ...
  const allIncludes = Object.keys(responseClone.includes || {}).reduce((all3, type) => [...all3, ...response.includes[type]], []);
